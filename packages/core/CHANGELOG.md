...
## [0.5.1](https://github.com/daonhan/ralph/compare/ralph-core-v0.6.3...ralph-core-v0.5.1) (2026-06-04)
...
* **core:** print cli + core version banner at loop init ([2cc0fbc](https://github.com/daonhan/ralph/commit/2cc0fbcde7858ad01be0e0fbc0256b351f9ef51e))
* **core:** wire RALPH_MODEL through to sandbox claude --model ([a76da10](https://github.com/daonhan/ralph/commit/a76da10c4615e4ae3b84d94873d2125fb4e54aa8))
...
* **loop:** use bin name in wake-lock reason for runLoop ([8299ad8](https://github.com/daonhan/ralph/commit/8299ad81a2c2f51f5833a3e278c32c15ea872261))
...
* **core:** document docker-kill recovery for ralph-core &lt;= 0.6.0 post-result hang ([3e8cf76](https://github.com/daonhan/ralph/commit/3e8cf760268c96a03ae5646eacca8d30f1e69cdb))
* **core:** grace-timer streamDocker recovers from post-result claude hang ([994ba05](https://github.com/daonhan/ralph/commit/994ba05fb02910bb573becb0047e0b6d1ece0280))
...
* **core:** post-result grace timer in streamDocker (closes [#30](https://github.com/daonhan/ralph/issues/30)) ([31a4312](https://github.com/daonhan/ralph/commit/31a43125540c1ca085d4727a6840f9d47a05cee4))
...
* **core:** warn on docker.sock mount; refactor bin/runner internals ([d5cd486](https://github.com/daonhan/ralph/commit/d5cd48696a850776e8b954e61b0e40dd9a1dec89))
...
* remove package-lock.json, improve JSDoc, rename stageWithPerm ([18f9150](https://github.com/daonhan/ralph/commit/18f915079744b992844d493e7a1edb0dfb635f91))
...
* **main:** release ralph-core 0.5.1 ([b160bf9](https://github.com/daonhan/ralph/commit/b160bf9814530b3c4299a36cca779feae663af98))
* **main:** release ralph-core 0.5.1 ([01c8066](https://github.com/daonhan/ralph/commit/01c806686d644b052a7a30fb83ea39c33b1a63a4))
...
* prepare repo for open-source release ([2970c34](https://github.com/daonhan/ralph/commit/2970c34583f2a586d6554d0027292707cd8da070))
...
* **release:** bump @daonhan/ralph-core and @daonhan/ralph to 0.6.1 ([aa04fbd](https://github.com/daonhan/ralph/commit/aa04fbdb7fd49e2e3bb4e65caf0900da29143bf0))
* **release:** bump ralph and ralph-core to 0.6.2 ([5e90031](https://github.com/daonhan/ralph/commit/5e9003109189b7696ff94fa61036d06b9f27b6c5))
